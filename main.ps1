...
<Window x:Class="WinUtility.MainWindow"
        ...
        Title="Windows Utility" Height="800" Width="1200">
...
$WPFtweaksbutton.Add_Click({
        ...
        If ( $WPFEssTweaksRemoveEdge.IsChecked -eq $true ) {
            ...
            Invoke-WebRequest -useb https://raw.githubusercontent.com/padsalatushal/Edge-Removal/main/Edge_Removal.bat | Invoke-Expression
            $WPFEssTweaksRemoveEdge.IsChecked = $false
        }
